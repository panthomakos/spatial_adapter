...
The gem depdencencies can be installed with bundler. There are different
development dependencies for jRuby and Ruby. To ensure you have the proper
gem dependencies installed, run `bundle install` after switching ruby platforms.
